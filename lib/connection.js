 ...
 * @private
 */
Connection.prototype.raiseSuccess = function( code, notification ) {
	debug( "Raising success:", code, notification );
	if( typeof this.options.successCallback === 'function' ) {
		this.options.successCallback( code, notification );
	}
};
/**
...
Connection.prototype.sendNotification = function (notification) {
	...
	}.bind(this)).then(function ( code ) {
		this.raiseSuccess( code, notification );
	}.bind(this));
};
